        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                src="{{ asset('dnvmaster/frontend/admin/img/master/logo_light.svg') }}" alt="navbar brand" class="navbar-brand" height="20">
            </a>
      ...
      <div class="main-panel">
        <div class="main-header">
          <div class="main-header-logo">
            ...
            <div class="logo-header" data-background-color="dark">
              <a href="index.html" class="logo">
                <img src="{{ asset('dnvmaster/frontend/admin/img/master/logo_light.svg') }}" alt="navbar brand" class="navbar-brand" height="20">
              </a>
              <div class="nav-toggle">
                <button class="btn btn-toggle toggle-sidebar">
                  <i class="gg-menu-right"></i>
            ...
            <div class="container-fluid">
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('dnvmaster/frontend/admin/img/jm_denis.jpg') }}"
                                alt="Img Profile"
                              />
                            </div>
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('dnvmaster/frontend/admin/img/chadengle.jpg') }}" alt="Img Profile">
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img src="{{ asset('dnvmaster/frontend/admin/img/mlane.jpg') }}" alt="Img Profile">
                            </div>
                            <div class="notif-content">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img src="{{ asset('dnvmaster/frontend/admin/img/talha.jpg') }}" alt="Img Profile">
                            </div>
                            <div class="notif-content">
                      ...
                      <div class="notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          ...
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{ asset('dnvmaster/frontend/admin/img/profile2.jpg') }}" alt="Img Profile">
                            </div>
                            <div class="notif-content">
                              <span class="block">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img src="{{ asset('dnvmaster/frontend/admin/img/dnvmaster.jpg') }}" alt="..." class="avatar-img rounded-circle">
                    </div>
                    <span class="profile-username">
                      <span class="op-7">{{ __('Здравствуйте,') }}&nbsp;</span>
                      <span class="fw-bold">{{ __('DnvMaster') }}</span>
                    </span>
                  </a>
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      <li>
                        <div class="user-box">
                          <div class="avatar-lg">
                            <img src="{{ asset('dnvmaster/frontend/admin/img/dnvmaster.jpg') }}" alt="image profile"class="avatar-img rounded">
                          </div>
                          <div class="u-text">
                            <h4>{{ __('DnvMaster') }}</h4>
                            <p class="text-muted">dnvmaster50@gmail.com</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">{{ _('Мой профиль') }}</a>
                        <a class="dropdown-item" href="#">{{ _('Мой баланс') }}</a>
                        <a class="dropdown-item" href="#">{{ _('Входящие') }}</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#">{{ _('Настройки') }}</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('logout') }}">{{ _('Выход') }}</a>
                      </li>
                    </div>
                  </ul>
                </li>
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">{{ __('Администрирование') }}</h4>
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                  <a href="#">{{ __('Панель администратора') }}</a>
                </li>
                <li class="separator">
                  <i class="icon-arrow-right"></i>
                </li>
                <li class="nav-item">
                  <a href="#">{{ __('Главная страница') }}</a>
                </li>
              </ul>
            </div>
            <div class="page-category">{{ __('Настройки, редактирование, изменение, добавление и удаление всех страниц сайта для администратора.') }}</div>
          </div>
        </div>
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            <nav class="pull-left">
              <ul class="nav">
                <li class="nav-item">
                  <a class="nav-link" href="https://guthum.com/DnvMaster">
                    {{ __('DnvMaster') }}
                  </a>
                </li> 
              </ul>
            ...
            <div class="copyright">
              {{ __('2025, создано') }} &nbsp;<i class="fa fa-heart heart text-danger"></i>&nbsp;
              <a href="https://github.com/DnvMaster">{{ __('DnvMaster') }}</a>
            </div>
          </div>
        </footer>
      </div>
